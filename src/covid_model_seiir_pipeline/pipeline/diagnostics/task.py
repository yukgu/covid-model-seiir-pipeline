...
def run_grid_plots(diagnostics_version: str, name: str, progress_bar: bool) -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir_name:
        ...
        hierarchy = pd.read_csv('/ihme/covid-19/model-inputs/best/locations/gbd_analysis_hierarchy.csv')
        deaths = plot_versions[0].load_output_summaries('daily_deaths').reset_index()
